# 0 "stm/src/dma_common.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/dma_common.c"
# 17 "stm/src/dma_common.c"
...
# 18 "stm/src/dma_common.c" 2

# 1 "stm/src/dma_impl.h" 1
# 37 "stm/src/dma_impl.h"
...
# 120 "stm/src/dma.h"
    ...
    void dmaSetHandler(
            ...
            uint32_t priority,
            uint32_t userParam);
# 40 "stm/src/dma_impl.h" 2

extern dmaChannelDescriptor_t dmaDescriptors[];
# 20 "stm/src/dma_common.c" 2
