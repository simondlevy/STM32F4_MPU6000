...
static void enable(IO_t io, 
# 105 "stm/src/exti.c" 3 4
                           _Bool 
# 105 "stm/src/exti.c"
                                enable)
{
...
{
    uint32_t exti_active = ((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR) & (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR)) & mask;

    (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR) = exti_active;
...
# 155 "stm/src/exti.c"
void EXTI0_IRQHandler(void) { EXTI_IRQHandler(0x0001 & 0xFFFF); } struct dummy;
void EXTI1_IRQHandler(void) { EXTI_IRQHandler(0x0002 & 0xFFFF); } struct dummy;
void EXTI2_IRQHandler(void) { EXTI_IRQHandler(0x0004 & 0xFFFF); } struct dummy;
void EXTI3_IRQHandler(void) { EXTI_IRQHandler(0x0008 & 0xFFFF); } struct dummy;
void EXTI4_IRQHandler(void) { EXTI_IRQHandler(0x0010 & 0xFFFF); } struct dummy;
void EXTI9_5_IRQHandler(void) { EXTI_IRQHandler(0x03e0 & 0xFFFF); } struct dummy;
void EXTI15_10_IRQHandler(void) { EXTI_IRQHandler(0xfc00 & 0xFFFF); } struct dummy;
...
void attachInterrupt(const uint8_t pin, extiHandlerCallback * isr)
{
    ...
    config(mpuIntIO, &exti, (((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)),
            BETAFLIGHT_EXTI_TRIGGER_RISING);

    enable(mpuIntIO, 
# 176 "stm/src/exti.c" 3 4
                    1
# 176 "stm/src/exti.c"
                        );
}
