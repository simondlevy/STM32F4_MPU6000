...
# 24 "stm/src/inverter.c" 2

static const ioTag_t INVERTER[(10 + 2)] = {0, 0, 57, 0, 0, 56, 0, 0, 0, 0, 0, 0};

static void inverterSet(int identifier, 
# 27 "stm/src/inverter.c" 3 4
                                       _Bool 
# 27 "stm/src/inverter.c"
                                            on)
{
    IO_t pin = IOGetByTag(INVERTER[(((identifier) < 10) ? (identifier) : (10 + ((identifier) - SERIAL_PORT_SOFTSERIAL1)))]);
...
{
    int uartIndex = (((identifier) < 10) ? (identifier) : (10 + ((identifier) - SERIAL_PORT_SOFTSERIAL1)));
...
# 44 "stm/src/inverter.c" 3 4
                           0
# 44 "stm/src/inverter.c"
                                );
}
...
void enableInverter(USART_TypeDef *USARTx, 
# 53 "stm/src/inverter.c" 3 4
                                          _Bool 
# 53 "stm/src/inverter.c"
                                               on)
{
    ...
    if (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00))) {
