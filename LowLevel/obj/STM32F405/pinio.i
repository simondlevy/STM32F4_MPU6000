...
# 30 "stm/src/pinio.h" 3 4
                        _Bool 
# 30 "stm/src/pinio.h"
                             on);
# 23 "stm/src/pinio.c" 2
...
# 31 "stm/src/pinio.c" 3 4
   _Bool 
# 31 "stm/src/pinio.c"
        inverted;
    
# 32 "stm/src/pinio.c" 3 4
   _Bool 
# 32 "stm/src/pinio.c"
        state;
} pinioRuntime_t;
...
# 68 "stm/src/pinio.c" 3 4
                                      1
# 68 "stm/src/pinio.c"
                                          ;
            IOHi(io);
            pinioRuntime[i].state = 
# 70 "stm/src/pinio.c" 3 4
                                   1
# 70 "stm/src/pinio.c"
                                       ;
        } else {
            pinioRuntime[i].inverted = 
# 72 "stm/src/pinio.c" 3 4
                                      0
# 72 "stm/src/pinio.c"
                                           ;
            IOLo(io);
            pinioRuntime[i].state = 
# 74 "stm/src/pinio.c" 3 4
                                   0
# 74 "stm/src/pinio.c"
                                        ;
        }
...
void pinioSet(int index, 
# 80 "stm/src/pinio.c" 3 4
                        _Bool 
# 80 "stm/src/pinio.c"
                             on)
{
    
# 82 "stm/src/pinio.c" 3 4
   _Bool 
# 82 "stm/src/pinio.c"
