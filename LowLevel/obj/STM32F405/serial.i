...
# 33 "/opt/gcc-arm-11.2-2022.02-x86_64-arm-none-eabi/arm-none-eabi/include/stdlib.h" 3
...
static serialPortUsage_t _serialPortUsageList[9];
        ...
        serialPortIdentifier_e identifier)
{
    ...
    return 
# 49 "stm/src/serial.c" 3 4
          ((void *)0)
# 49 "stm/src/serial.c"
              ;
}

static const serialPortIdentifier_e serialPortIdentifiers[9] = {
    SERIAL_PORT_USB_VCP,
    SERIAL_PORT_USART1,
    SERIAL_PORT_USART2,
    SERIAL_PORT_USART3,
...
void serialInit(serialPortIdentifier_e serialPortToDisable)
{
    ...
    for (int index = 0; index < 9; index++) {
        ...
        if (serialPortToDisable != SERIAL_PORT_NONE) {
            ...
            int resourceIndex =
                (((_serialPortUsageList[index].identifier) < 10) ? (_serialPortUsageList[index].identifier) : (10 + ((_serialPortUsageList[index].identifier) - SERIAL_PORT_SOFTSERIAL1)))
                                                               ;
...
# 91 "stm/src/serial.c" 3 4
_Bool 
# 91 "stm/src/serial.c"
    serialIsTransmitBufferEmpty(void * p)
{
    ...
    portOptions_e options)
{
    ...
    if (!serialPortUsage || serialPortUsage->function != FUNCTION_NONE) {
        ...
        return 
# 112 "stm/src/serial.c" 3 4
              ((void *)0)
# 112 "stm/src/serial.c"
                  ;
    }

    serialPort_t *serialPort = 
# 115 "stm/src/serial.c" 3 4
                              ((void *)0)
# 115 "stm/src/serial.c"
                                  ;
    ...
    switch (identifier) {
        ...
        case SERIAL_PORT_USART6:
            serialPort = uartOpen(((identifier) - SERIAL_PORT_USART1 + UARTDEV_1),
    ...
    if (!serialPort) {
        return 
# 137 "stm/src/serial.c" 3 4
              ((void *)0)
# 137 "stm/src/serial.c"
                  ;
    }
...
# 228 "stm/src/serial.c" 3 4
           ((void *)0)
# 228 "stm/src/serial.c"
               , 
# 228 "stm/src/serial.c" 3 4
                 ((void *)0)
# 228 "stm/src/serial.c"
