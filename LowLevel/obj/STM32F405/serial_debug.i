# 0 "stm/src/serial_debug.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/serial_debug.c"
# 20 "stm/src/serial_debug.c"
# 1 "hfsrc/serial.h" 1
# 19 "hfsrc/serial.h"
        ...
        if (ch != '%') {
            ...
            switch (ch) {
                ...
                case 'u':{
                             if (lng)
                                 uli2a(
# 158 "stm/src/serial_debug.c" 3 4
                                      __builtin_va_arg(
# 158 "stm/src/serial_debug.c"
                                      va
# 158 "stm/src/serial_debug.c" 3 4
                                      ,
# 158 "stm/src/serial_debug.c"
...
# 158 "stm/src/serial_debug.c"
                                 ...
                                 ui2a(
# 160 "stm/src/serial_debug.c" 3 4
                                     __builtin_va_arg(
# 160 "stm/src/serial_debug.c"
                                     va
# 160 "stm/src/serial_debug.c" 3 4
                                     ,
# 160 "stm/src/serial_debug.c"
...
# 160 "stm/src/serial_debug.c"
                ...
                case 'd':{
                             if (lng)
                                 li2a(
# 166 "stm/src/serial_debug.c" 3 4
                                     __builtin_va_arg(
# 166 "stm/src/serial_debug.c"
                                     va
# 166 "stm/src/serial_debug.c" 3 4
                                     ,
# 166 "stm/src/serial_debug.c"
...
# 166 "stm/src/serial_debug.c"
                                 ...
                                 i2a(
# 168 "stm/src/serial_debug.c" 3 4
                                    __builtin_va_arg(
# 168 "stm/src/serial_debug.c"
                                    va
# 168 "stm/src/serial_debug.c" 3 4
                                    ,
# 168 "stm/src/serial_debug.c"
...
# 168 "stm/src/serial_debug.c"
                ...
                case 'X':
                         if (lng)
                             uli2a(
# 175 "stm/src/serial_debug.c" 3 4
                                  __builtin_va_arg(
# 175 "stm/src/serial_debug.c"
                                  va
# 175 "stm/src/serial_debug.c" 3 4
                                  ,
# 175 "stm/src/serial_debug.c"
...
# 175 "stm/src/serial_debug.c"
                             ...
                             ui2a(
# 177 "stm/src/serial_debug.c" 3 4
                                 __builtin_va_arg(
# 177 "stm/src/serial_debug.c"
                                 va
# 177 "stm/src/serial_debug.c" 3 4
                                 ,
# 177 "stm/src/serial_debug.c"
...
# 177 "stm/src/serial_debug.c"
                ...
                case 'c':
                         putf(putp, (char) (
# 181 "stm/src/serial_debug.c" 3 4
                                           __builtin_va_arg(
# 181 "stm/src/serial_debug.c"
                                           va
# 181 "stm/src/serial_debug.c" 3 4
                                           ,
# 181 "stm/src/serial_debug.c"
...
# 184 "stm/src/serial_debug.c" 3 4
                                                            __builtin_va_arg(
# 184 "stm/src/serial_debug.c"
                                                            va
# 184 "stm/src/serial_debug.c" 3 4
                                                            ,
# 184 "stm/src/serial_debug.c"
...
# 184 "stm/src/serial_debug.c"
                ...
                case 'n':
                         *
# 190 "stm/src/serial_debug.c" 3 4
                         __builtin_va_arg(
# 190 "stm/src/serial_debug.c"
                         va
# 190 "stm/src/serial_debug.c" 3 4
                         ,
# 190 "stm/src/serial_debug.c"
...
# 221 "stm/src/serial_debug.c" 3 4
   __builtin_va_start(
# 221 "stm/src/serial_debug.c"
   va
# 221 "stm/src/serial_debug.c" 3 4
   ,
# 221 "stm/src/serial_debug.c"
...
# 221 "stm/src/serial_debug.c"
                    ;
    tfp_format(
# 222 "stm/src/serial_debug.c" 3 4
              ((void *)0)
# 222 "stm/src/serial_debug.c"
                  , stdout_putf, fmt, va);
    
# 223 "stm/src/serial_debug.c" 3 4
   __builtin_va_end(
# 223 "stm/src/serial_debug.c"
   va
# 223 "stm/src/serial_debug.c" 3 4
   )
# 223 "stm/src/serial_debug.c"
