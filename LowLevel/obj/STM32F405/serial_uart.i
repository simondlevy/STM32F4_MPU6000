...
# 29 "stm/src/serial_uart.c" 2
# 1 "stm/src/serial_uart_impl.h" 1
# 38 "stm/src/serial_uart_impl.h"
...
typedef struct uartHardware_s {
    ...
    uartPinDef_t rxPins[4];
    uartPinDef_t txPins[4];
...
# 114 "stm/src/serial_uart_impl.h"
extern volatile uint8_t uart1RxBuffer[128]; extern volatile uint8_t uart1TxBuffer[256]; struct dummy_s;
extern volatile uint8_t uart2RxBuffer[128]; extern volatile uint8_t uart2TxBuffer[256]; struct dummy_s;
extern volatile uint8_t uart3RxBuffer[128]; extern volatile uint8_t uart3TxBuffer[256]; struct dummy_s;
extern volatile uint8_t uart4RxBuffer[128]; extern volatile uint8_t uart4TxBuffer[256]; struct dummy_s;
extern volatile uint8_t uart5RxBuffer[128]; extern volatile uint8_t uart5TxBuffer[256]; struct dummy_s;
extern volatile uint8_t uart6RxBuffer[128]; extern volatile uint8_t uart6TxBuffer[256]; struct dummy_s;
extern volatile uint8_t lpuart1RxBuffer[128]; extern volatile uint8_t lpuart1TxBuffer[256]; struct dummy_s;
# 30 "stm/src/serial_uart.c" 2
# 42 "stm/src/serial_uart.c"
 volatile uint8_t uart1TxBuffer[256]; volatile uint8_t uart1RxBuffer[128]; struct dummy_s;
 volatile uint8_t uart2TxBuffer[256]; volatile uint8_t uart2RxBuffer[128]; struct dummy_s;
 volatile uint8_t uart3TxBuffer[256]; volatile uint8_t uart3RxBuffer[128]; struct dummy_s;
 volatile uint8_t uart4TxBuffer[256]; volatile uint8_t uart4RxBuffer[128]; struct dummy_s;
 volatile uint8_t uart5TxBuffer[256]; volatile uint8_t uart5RxBuffer[128]; struct dummy_s;
 volatile uint8_t uart6TxBuffer[256]; volatile uint8_t uart6RxBuffer[128]; struct dummy_s;
...
serialPort_t *uartOpen(UARTDevice_e device, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    uartPort->txDMAEmpty = 
# 58 "stm/src/serial_uart.c" 3 4
                          1
# 58 "stm/src/serial_uart.c"
                              ;
...
static uint32_t uartTotalRxBytesWaiting(const serialPort_t *instance)
{
    ...
    if (uartPort->rxDMAResource) {
        ...
        uint32_t rxDMAHead = DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(uartPort->rxDMAResource));
...
static uint32_t uartTotalTxBytesFree(const serialPort_t *instance)
{
    ...
    if (uartPort->txDMAResource) {
        ...
        bytesUsed += DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(uartPort->txDMAResource));
# 140 "stm/src/serial_uart.c"
...
static 
# 148 "stm/src/serial_uart.c" 3 4
      _Bool 
# 148 "stm/src/serial_uart.c"
...
static void uartWrite(serialPort_t *instance, uint8_t ch)
{
    ...
    if (uartPort->txDMAResource) {
        ...
        USART_ITConfig(uartPort->USARTx, ((uint16_t)0x0727), ENABLE);
    }
}
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .setCtrlLineStateCb = 
# 207 "stm/src/serial_uart.c" 3 4
                             ((void *)0)
# 207 "stm/src/serial_uart.c"
                                 ,
        .setBaudRateCb = 
# 208 "stm/src/serial_uart.c" 3 4
                        ((void *)0)
# 208 "stm/src/serial_uart.c"
                            ,
        .writeBuf = 
# 209 "stm/src/serial_uart.c" 3 4
                   ((void *)0)
# 209 "stm/src/serial_uart.c"
                       ,
        .beginWrite = 
# 210 "stm/src/serial_uart.c" 3 4
                     ((void *)0)
# 210 "stm/src/serial_uart.c"
                         ,
        .endWrite = 
# 211 "stm/src/serial_uart.c" 3 4
                   ((void *)0)
# 211 "stm/src/serial_uart.c"
                       ,
    }
};
...
void uartConfigureDma(uartDevice_t *uartdev)
{
    ...
    if (uartPort->txDMAResource) {
        ...
        if (dmaAllocate(identifier, OWNER_SERIAL_TX, (hardware->device + 1))) {
            dmaEnable(identifier);
            dmaSetHandler(identifier, uartDmaIrqHandler, hardware->txPriority, (uint32_t)uartdev);
            uartPort->txDMAPeripheralBaseAddr = (uint32_t)&((hardware->reg)->DR);
        }
    }

    if (uartPort->rxDMAResource) {
        dmaIdentifier_e identifier = dmaGetIdentifier(uartPort->rxDMAResource);
        if (dmaAllocate(identifier, OWNER_SERIAL_RX, (hardware->device + 1))) {
            dmaEnable(identifier);
            uartPort->rxDMAPeripheralBaseAddr = (uint32_t)&((hardware->reg)->DR);
        }
    }
}
# 245 "stm/src/serial_uart.c"
void USART1_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_1]->port); uartIrqHandler(uartPort); }
void USART2_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_2]->port); uartIrqHandler(uartPort); }
void USART3_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_3]->port); uartIrqHandler(uartPort); }
void UART4_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_4]->port); uartIrqHandler(uartPort); }
void UART5_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_5]->port); uartIrqHandler(uartPort); }
void USART6_IRQHandler(void) { uartPort_t *uartPort = &(uartDevmap[UARTDEV_6]->port); uartIrqHandler(uartPort); }
