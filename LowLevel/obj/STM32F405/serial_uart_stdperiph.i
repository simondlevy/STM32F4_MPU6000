# 0 "stm/src/serial_uart_stdperiph.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/serial_uart_stdperiph.c"
# 17 "stm/src/serial_uart_stdperiph.c"
# 1 "/opt/gcc-arm-11.2-2022.02-x86_64-arm-none-eabi/lib/gcc/arm-none-eabi/11.2.1/include/stdbool.h" 1 3 4
# 18 "stm/src/serial_uart_stdperiph.c" 2
...
# 19 "stm/src/serial_uart_stdperiph.c" 2
...
# 21 "stm/src/serial_uart_stdperiph.c" 2
...
# 22 "stm/src/serial_uart_stdperiph.c" 2
...
# 21 "stm/src/inverter.h" 3 4
                                          _Bool 
# 21 "stm/src/inverter.h"
                                               on);
void inverterInit(void);
# 24 "stm/src/serial_uart_stdperiph.c" 2
# 1 "stm/src/nvic.h" 1
# 17 "stm/src/nvic.h"
       
# 25 "stm/src/serial_uart_stdperiph.c" 2
...
# 27 "stm/src/serial_uart_stdperiph.c" 2
...
# 29 "stm/src/serial_uart_stdperiph.c" 2
...
# 30 "stm/src/serial_uart_stdperiph.c" 2
...
# 31 "stm/src/serial_uart_stdperiph.c" 2

static void usartConfigurePinInversion(uartPort_t *uartPort) {
    
# 33 "stm/src/serial_uart_stdperiph.c" 3 4
   _Bool 
# 33 "stm/src/serial_uart_stdperiph.c"
        inverted = uartPort->port.options & SERIAL_INVERTED;

    if (inverted) {

        enableInverter(uartPort->USARTx, 
# 37 "stm/src/serial_uart_stdperiph.c" 3 4
                                        1
# 37 "stm/src/serial_uart_stdperiph.c"
                                            );
    }
}
...
void uartReconfigure(uartPort_t *uartPort)
{
    ...
    if (uartPort->port.mode & MODE_RX) {
        if (uartPort->rxDMAResource) {
            ...
            DMA_DeInit((DMA_Stream_TypeDef *)(uartPort->rxDMAResource));
            DMA_Init((DMA_Stream_TypeDef *)(uartPort->rxDMAResource), &DMA_InitStructure);
            DMA_Cmd((DMA_Stream_TypeDef *)(uartPort->rxDMAResource), ENABLE);
            USART_DMACmd(uartPort->USARTx, ((uint16_t)0x0040), ENABLE);
            uartPort->rxDMAPos = DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(uartPort->rxDMAResource));
        } else {
            USART_ClearITPendingBit(uartPort->USARTx, ((uint16_t)0x0525));
            USART_ITConfig(uartPort->USARTx, ((uint16_t)0x0525), ENABLE);
            USART_ITConfig(uartPort->USARTx, ((uint16_t)0x0424), ENABLE);
        }
    }
    ...
    if (uartPort->port.mode & MODE_TX) {
        if (uartPort->txDMAResource) {
            ...
            DMA_DeInit((DMA_Stream_TypeDef *)(uartPort->txDMAResource));
            DMA_Init((DMA_Stream_TypeDef *)(uartPort->txDMAResource), &DMA_InitStructure);

            DMA_ITConfig((DMA_Stream_TypeDef *)(uartPort->txDMAResource), ((uint32_t)0x00000010) | ((uint32_t)0x00000080) | ((uint32_t)0x00000004) | ((uint32_t)0x00000002), ENABLE);

            DMA_SetCurrDataCounter((DMA_Stream_TypeDef *)(uartPort->txDMAResource), 0);
            USART_DMACmd(uartPort->USARTx, ((uint16_t)0x0080), ENABLE);
        } else {
...
void uartTryStartTxDMA(uartPort_t *s)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        if ((((DMA_Stream_TypeDef *)(s->txDMAResource))->CR & ((uint32_t)0x00000001))) {
        ...
        if (DMA_GetCurrDataCounter((DMA_Stream_TypeDef *)(s->txDMAResource))) {
        ...
        if (s->port.txBufferHead == s->port.txBufferTail) {
            ...
            s->txDMAEmpty = 
# 170 "stm/src/serial_uart_stdperiph.c" 3 4
                           1
# 170 "stm/src/serial_uart_stdperiph.c"
                               ;
            return;
        }
        ...
        DMA_MemoryTargetConfig((DMA_Stream_TypeDef *)(s->txDMAResource), (uint32_t)&s->port.txBuffer[s->port.txBufferTail], ((uint32_t)0x00000000));

        if (s->port.txBufferHead > s->port.txBufferTail) {
            DMA_SetCurrDataCounter((DMA_Stream_TypeDef *)(s->txDMAResource), s->port.txBufferHead - s->port.txBufferTail);
            s->port.txBufferTail = s->port.txBufferHead;
        } else {
            DMA_SetCurrDataCounter((DMA_Stream_TypeDef *)(s->txDMAResource), s->port.txBufferSize - s->port.txBufferTail);
            s->port.txBufferTail = 0;
        }
        s->txDMAEmpty = 
# 185 "stm/src/serial_uart_stdperiph.c" 3 4
                       0
# 185 "stm/src/serial_uart_stdperiph.c"
                            ;

    reenable:
        DMA_Cmd((DMA_Stream_TypeDef *)(s->txDMAResource), ENABLE);
    }
}
