# 0 "stm/src/serial_usb_vcp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/serial_usb_vcp.c"
# 17 "stm/src/serial_usb_vcp.c"
...
# 25 "stm/src/serial_usb_vcp.c" 2

# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 1
# 33 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h"
# 1 "stm/src/vcpf4/usb_conf.h" 1
# 34 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 2
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h" 1
# 83 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_GREGS;
# 113 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_DREGS;
# 145 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_INEPREGS;
# 165 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_OUTEPREGS;
# 184 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_HREGS;
# 203 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
USB_OTG_HC_REGS;
# 222 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h"
...
# 35 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 2
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_defines.h" 1
# 190 "stm/lib/STM32_USB_OTG_Driver/inc/usb_defines.h"
typedef enum
{
  USB_OTG_HS_CORE_ID = 0,
  USB_OTG_FS_CORE_ID = 1
}USB_OTG_CORE_ID_TypeDef;
# 233 "stm/lib/STM32_USB_OTG_Driver/inc/usb_defines.h"
enum USB_OTG_SPEED {
  USB_SPEED_UNKNOWN = 0,
  USB_SPEED_LOW,
  USB_SPEED_FULL,
...
# 36 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 2
# 79 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h"
typedef enum {
  USB_OTG_OK = 0,
  USB_OTG_FAIL
}USB_OTG_STS;
...
# 228 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h"
...
# 331 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h"
...
USB_OTG_STS USB_OTG_SetCurrentMode (USB_OTG_CORE_HANDLE *pdev,
    uint8_t mode);
# 373 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h"
...
# 27 "stm/src/serial_usb_vcp.c" 2
# 1 "stm/src/vcpf4/usbd_cdc_vcp.h" 1
# 27 "stm/src/vcpf4/usbd_cdc_vcp.h"
# 1 "stm/lib/STM32F4/Drivers/CMSIS/Device/ST/STM32F4xx/stm32f4xx_conf.h" 1
# 28 "stm/src/vcpf4/usbd_cdc_vcp.h" 2

# 1 "stm/lib/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h" 1
# 33 "stm/lib/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h" 1
# 34 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_def.h" 1
# 34 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_def.h"
# 1 "stm/src/vcpf4/usbd_conf.h" 1
# 35 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_def.h" 2
# 35 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h" 2
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h" 1
# 33 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h"
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_dcd.h" 1
# 33 "stm/lib/STM32_USB_OTG_Driver/inc/usb_dcd.h"
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 1
# 34 "stm/lib/STM32_USB_OTG_Driver/inc/usb_dcd.h" 2
# 72 "stm/lib/STM32_USB_OTG_Driver/inc/usb_dcd.h"
typedef struct
{
  uint8_t bLength;
...
# 108 "stm/lib/STM32_USB_OTG_Driver/inc/usb_dcd.h"
...
void DCD_SetEPStatus (USB_OTG_CORE_HANDLE *pdev ,
                      uint8_t epnum ,
                      uint32_t Status);
# 34 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h" 2
# 51 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h"
typedef enum {
  USBD_OK = 0,
  USBD_BUSY,
  USBD_FAIL,
}USBD_Status;
# 91 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h"
...
# 36 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h" 2
# 85 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h"
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 34 "stm/lib/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h" 2
# 93 "stm/lib/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
...
CDC_IF_Prop_TypeDef;
# 120 "stm/lib/STM32_USB_Device_Library/Class/cdc/inc/usbd_cdc_core.h"
extern USBD_Class_cb_TypeDef USBD_CDC_cb;
# 30 "stm/src/vcpf4/usbd_cdc_vcp.h" 2
# 1 "stm/src/vcpf4/usbd_conf.h" 1
# 31 "stm/src/vcpf4/usbd_cdc_vcp.h" 2


# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h" 1
# 34 "stm/src/vcpf4/usbd_cdc_vcp.h" 2
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_usr.h" 1
# 33 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_usr.h"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_ioreq.h" 1
# 34 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_usr.h" 2
# 52 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_usr.h"
extern USBD_Usr_cb_TypeDef USR_cb;
extern USBD_Usr_cb_TypeDef USR_FS_cb;
extern USBD_Usr_cb_TypeDef USR_HS_cb;
# 83 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_usr.h"
...
# 35 "stm/src/vcpf4/usbd_cdc_vcp.h" 2
# 1 "stm/src/vcpf4/usbd_desc.h" 1
# 28 "stm/src/vcpf4/usbd_desc.h"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_def.h" 1
# 29 "stm/src/vcpf4/usbd_desc.h" 2
# 74 "stm/src/vcpf4/usbd_desc.h"
...
# 36 "stm/src/vcpf4/usbd_cdc_vcp.h" 2
...
# 28 "stm/src/serial_usb_vcp.c" 2
# 1 "stm/lib/STM32_USB_Device_Library/Class/hid_cdc_wrapper/inc/usbd_hid_cdc_wrapper.h" 1
# 78 "stm/lib/STM32_USB_Device_Library/Class/hid_cdc_wrapper/inc/usbd_hid_cdc_wrapper.h"
extern USBD_Class_cb_TypeDef USBD_HID_CDC_cb;
# 29 "stm/src/serial_usb_vcp.c" 2
...
# 33 "stm/src/serial_usb_vcp.c" 2

# 1 "stm/src/serial_usb_vcp.h" 1
# 17 "stm/src/serial_usb_vcp.h"
...
# 28 "stm/src/serial_usb_vcp.h" 3 4
   _Bool 
# 28 "stm/src/serial_usb_vcp.h"
        buffering;
} vcpPort_t;
...
static 
# 74 "stm/src/serial_usb_vcp.c" 3 4
      _Bool 
# 74 "stm/src/serial_usb_vcp.c"
           isUsbVcpTransmitBufferEmpty(const serialPort_t *instance)
{
    (void)(instance);
    return 
# 77 "stm/src/serial_usb_vcp.c" 3 4
          1
# 77 "stm/src/serial_usb_vcp.c"
              ;
}
...
static uint8_t usbVcpRead(serialPort_t *instance)
{
    ...
    while (
# 93 "stm/src/serial_usb_vcp.c" 3 4
          1
# 93 "stm/src/serial_usb_vcp.c"
              ) {
...
static 
# 120 "stm/src/serial_usb_vcp.c" 3 4
      _Bool 
# 120 "stm/src/serial_usb_vcp.c"
           usbVcpFlush(vcpPort_t *port)
{
    ...
    if (count == 0) {
        return 
# 126 "stm/src/serial_usb_vcp.c" 3 4
              1
# 126 "stm/src/serial_usb_vcp.c"
                  ;
    }

    if (!usbIsConnected() || !usbIsConfigured()) {
        return 
# 130 "stm/src/serial_usb_vcp.c" 3 4
              0
# 130 "stm/src/serial_usb_vcp.c"
                   ;
    }
...
# 149 "stm/src/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 149 "stm/src/serial_usb_vcp.c"
                     vcpPort_t
# 149 "stm/src/serial_usb_vcp.c" 3 4
                     , 
# 149 "stm/src/serial_usb_vcp.c"
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 159 "stm/src/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 159 "stm/src/serial_usb_vcp.c"
                     vcpPort_t
# 159 "stm/src/serial_usb_vcp.c" 3 4
                     , 
# 159 "stm/src/serial_usb_vcp.c"
...
# 159 "stm/src/serial_usb_vcp.c"
    ...
    port->buffering = 
# 160 "stm/src/serial_usb_vcp.c" 3 4
                     1
# 160 "stm/src/serial_usb_vcp.c"
                         ;
}
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - 
# 171 "stm/src/serial_usb_vcp.c" 3 4
                     __builtin_offsetof (
# 171 "stm/src/serial_usb_vcp.c"
                     vcpPort_t
# 171 "stm/src/serial_usb_vcp.c" 3 4
                     , 
# 171 "stm/src/serial_usb_vcp.c"
...
# 171 "stm/src/serial_usb_vcp.c"
    ...
    port->buffering = 
# 172 "stm/src/serial_usb_vcp.c" 3 4
                     0
# 172 "stm/src/serial_usb_vcp.c"
                          ;
    usbVcpFlush(port);
}
