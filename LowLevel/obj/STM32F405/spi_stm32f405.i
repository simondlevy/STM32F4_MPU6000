# 0 "stm/src/spi_stm32f405.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/spi_stm32f405.c"
# 17 "stm/src/spi_stm32f405.c"
...
# 120 "stm/src/dma.h"
    ...
    void dmaSetHandler(
            ...
            uint32_t priority,
            uint32_t userParam);
# 20 "stm/src/spi_stm32f405.c" 2

uint8_t spiInstanceDenom(const SPI_TypeDef *instance)
{
    return instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)) || instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)) ? 2 : 1;
}
