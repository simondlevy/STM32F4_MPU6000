# 0 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
# 72 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
# 1 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_flash.h" 1
# 38 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_flash.h"
...
# 39 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_flash.h" 2
...
# 73 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c" 2
# 277 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_SetLatency(uint32_t FLASH_Latency)
{
...
# 414 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_Unlock(void)
{
...
# 472 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_EraseSector(uint32_t FLASH_Sector, uint8_t VoltageRange)
{
...
# 540 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_EraseAllSectors(uint8_t VoltageRange)
{
  uint32_t tmp_psize = 0x0;
  FLASH_Status status = FLASH_COMPLETE;
  ...
  if(status == FLASH_COMPLETE)
  {
# 582 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR &= ((uint32_t)0xFFFFFCFF);
    ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= tmp_psize;
...
# 621 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_EraseAllBank1Sectors(uint8_t VoltageRange)
{
  uint32_t tmp_psize = 0x0;
  FLASH_Status status = FLASH_COMPLETE;
...
# 688 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_EraseAllBank2Sectors(uint8_t VoltageRange)
{
  uint32_t tmp_psize = 0x0;
  FLASH_Status status = FLASH_COMPLETE;
...
# 745 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_ProgramDoubleWord(uint32_t Address, uint64_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 788 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 830 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_ProgramHalfWord(uint32_t Address, uint16_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 872 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FLASH_Status FLASH_ProgramByte(uint32_t Address, uint8_t Data)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 971 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_Unlock(void)
{
...
# 1009 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_WRPConfig(uint32_t OB_WRP, FunctionalState NewState)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1051 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_WRP1Config(uint32_t OB_WRP, FunctionalState NewState)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1101 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_PCROPSelectionConfig(uint8_t OB_PcROP)
{
...
# 1132 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_PCROPConfig(uint32_t OB_PCROP, FunctionalState NewState)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1169 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_PCROP1Config(uint32_t OB_PCROP, FunctionalState NewState)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1205 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_RDPConfig(uint8_t OB_RDP)
{
  FLASH_Status status = FLASH_COMPLETE;
...
# 1237 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_UserConfig(uint8_t OB_IWDG, uint8_t OB_STOP, uint8_t OB_STDBY)
{
  uint8_t optiontmp = 0xFF;
  FLASH_Status status = FLASH_COMPLETE;
...
# 1278 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_BootConfig(uint8_t OB_BOOT)
{
...
# 1299 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_OB_BORConfig(uint8_t OB_BOR)
{
...
# 1360 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
uint16_t FLASH_OB_GetWRP1(void)
{

  return (*(volatile uint16_t *)(((uint32_t)0x40023C1A)));
}
# 1374 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
uint16_t FLASH_OB_GetPCROP(void)
{

  return (*(volatile uint16_t *)(((uint32_t)0x40023C16)));
}
# 1388 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
uint16_t FLASH_OB_GetPCROP1(void)
{

  return (*(volatile uint16_t *)(((uint32_t)0x40023C1A)));
}
# 1401 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FlagStatus FLASH_OB_GetRDP(void)
{
...
# 1425 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
uint8_t FLASH_OB_GetBOR(void)
{

  return (uint8_t)(*(volatile uint8_t *)(((uint32_t)0x40023C14)) & (uint8_t)0x0C);
}
# 1454 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState)
{
...
# 1486 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
FlagStatus FLASH_GetFlagStatus(uint32_t FLASH_FLAG)
{
...
# 1517 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_flash.c"
void FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
