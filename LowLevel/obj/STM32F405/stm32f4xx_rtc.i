# 0 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
# 285 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
# 1 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_rtc.h" 1
# 38 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_rtc.h"
...
# 39 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/inc/stm32f4xx_rtc.h" 2
...
# 286 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c" 2
# 318 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
static uint8_t RTC_ByteToBcd2(uint8_t Value);
static uint8_t RTC_Bcd2ToByte(uint8_t Value);
# 375 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_DeInit(void)
{
...
# 457 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_Init(RTC_InitTypeDef* RTC_InitStruct)
{
  ErrorStatus status = ERROR;
...
# 525 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_WriteProtectionCmd(FunctionalState NewState)
{
...
# 552 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_EnterInitMode(void)
{
...
# 597 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_ExitInitMode(void)
{

  ((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->ISR &= (uint32_t)~((uint32_t)0x00000080);
}
# 619 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_WaitForSynchro(void)
{
...
# 662 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_RefClockCmd(FunctionalState NewState)
{
  ErrorStatus status = ERROR;
...
# 710 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_BypassShadowCmd(FunctionalState NewState)
{
...
# 765 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 868 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TimeStructInit(RTC_TimeTypeDef* RTC_TimeStruct)
{
...
# 887 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_GetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint32_t tmpreg = 0;
...
# 920 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
uint32_t RTC_GetSubSecond(void)
{
  uint32_t tmpreg = 0;
...
# 945 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
  ErrorStatus status = ERROR;
...
# 1036 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_DateStructInit(RTC_DateTypeDef* RTC_DateStruct)
{
...
# 1055 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_GetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
  uint32_t tmpreg = 0;
...
# 1115 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_SetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
...
# 1226 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_AlarmStructInit(RTC_AlarmTypeDef* RTC_AlarmStruct)
{
...
# 1256 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_GetAlarm(uint32_t RTC_Format, uint32_t RTC_Alarm, RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint32_t tmpreg = 0;
...
# 1310 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_AlarmCmd(uint32_t RTC_Alarm, FunctionalState NewState)
{
...
# 1404 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_AlarmSubSecondConfig(uint32_t RTC_Alarm, uint32_t RTC_AlarmSubSecondValue, uint32_t RTC_AlarmSubSecondMask)
{
  uint32_t tmpreg = 0;
...
# 1445 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
uint32_t RTC_GetAlarmSubSecond(uint32_t RTC_Alarm)
{
  uint32_t tmpreg = 0;
...
# 1494 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock)
{
...
# 1521 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_SetWakeUpCounter(uint32_t RTC_WakeUpCounter)
{
...
# 1631 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_DayLightSavingConfig(uint32_t RTC_DayLightSaving, uint32_t RTC_StoreOperation)
{
...
# 1658 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
uint32_t RTC_GetStoreOperation(void)
{
  return (((RTC_TypeDef *) (((uint32_t)0x40000000) + 0x2800))->CR & ((uint32_t)0x00040000));
}
# 1697 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_OutputConfig(uint32_t RTC_Output, uint32_t RTC_OutputPolarity)
{
...
# 1751 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_CoarseCalibConfig(uint32_t RTC_CalibSign, uint32_t Value)
{
  ErrorStatus status = ERROR;
...
# 1792 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_CoarseCalibCmd(FunctionalState NewState)
{
  ErrorStatus status = ERROR;
...
# 1870 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_CalibOutputConfig(uint32_t RTC_CalibOutput)
{
...
# 1906 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_SmoothCalibConfig(uint32_t RTC_SmoothCalibPeriod,
                                  uint32_t RTC_SmoothCalibPlusPulses,
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
...
# 1982 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TimeStampCmd(uint32_t RTC_TimeStampEdge, FunctionalState NewState)
{
  uint32_t tmpreg = 0;
...
# 2026 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_GetTimeStamp(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_StampTimeStruct,
                                      RTC_DateTypeDef* RTC_StampDateStruct)
{
...
# 2105 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperTriggerConfig(uint32_t RTC_Tamper, uint32_t RTC_TamperTrigger)
{
...
# 2131 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperCmd(uint32_t RTC_Tamper, FunctionalState NewState)
{
...
# 2162 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperFilterConfig(uint32_t RTC_TamperFilter)
{
...
# 2196 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperSamplingFreqConfig(uint32_t RTC_TamperSamplingFreq)
{
...
# 2219 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperPinsPrechargeDuration(uint32_t RTC_TamperPrechargeDuration)
{
...
# 2239 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TimeStampOnTamperDetectionCmd(FunctionalState NewState)
{
...
# 2303 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_WriteBackupRegister(uint32_t RTC_BKP_DR, uint32_t Data)
{
...
# 2324 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
uint32_t RTC_ReadBackupRegister(uint32_t RTC_BKP_DR)
{
  volatile uint32_t tmp = 0;
...
# 2363 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TamperPinSelection(uint32_t RTC_TamperPin)
{
...
# 2380 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_TimeStampPinSelection(uint32_t RTC_TimeStampPin)
{
...
# 2399 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_OutputTypeConfig(uint32_t RTC_OutputType)
{
...
# 2437 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
  ErrorStatus status = ERROR;
...
# 2557 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState)
{
...
# 2606 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
FlagStatus RTC_GetFlagStatus(uint32_t RTC_FLAG)
{
...
# 2643 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_ClearFlag(uint32_t RTC_FLAG)
{
...
# 2664 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
ITStatus RTC_GetITStatus(uint32_t RTC_IT)
{
...
# 2705 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
  uint32_t tmpreg = 0;
...
# 2728 "stm/lib/STM32F4/Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rtc.c"
static uint8_t RTC_ByteToBcd2(uint8_t Value)
{
  uint8_t bcdhigh = 0;
