# 0 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
# 29 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 30 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c" 2
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_bsp.h" 1
# 33 "stm/lib/STM32_USB_OTG_Driver/inc/usb_bsp.h"
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_core.h" 1
# 34 "stm/lib/STM32_USB_OTG_Driver/inc/usb_bsp.h" 2
...
# 31 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c" 2
# 95 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 168 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_WritePacket(USB_OTG_CORE_HANDLE *pdev,
                                uint8_t *src,
                                uint8_t ch_ep_num,
                                uint16_t len)
...
# 198 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
void *USB_OTG_ReadPacket(USB_OTG_CORE_HANDLE *pdev,
                         uint8_t *dest,
                         uint16_t len)
{
...
# 222 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_SelectCore(USB_OTG_CORE_HANDLE *pdev,
                               USB_OTG_CORE_ID_TypeDef coreID)
{
...
# 251 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
  }
...
# 280 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
  }
...
# 328 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInit(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
...
# 437 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
  return status;
}
...
# 463 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_DisableGlobalInt(USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_GAHBCFG_TypeDef ahbcfg;
...
# 480 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_FlushTxFifo (USB_OTG_CORE_HANDLE *pdev , uint32_t num )
{
  USB_OTG_STS status = USB_OTG_OK;
  volatile USB_OTG_GRSTCTL_TypeDef greset;
...
# 540 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1209 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_InitDevSpeed(USB_OTG_CORE_HANDLE *pdev , uint8_t speed)
{
...
# 1225 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_CoreInitDev (USB_OTG_CORE_HANDLE *pdev)
{
  USB_OTG_STS status = USB_OTG_OK;
...
# 1337 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1448 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
enum USB_OTG_SPEED USB_OTG_GetDeviceSpeed (USB_OTG_CORE_HANDLE *pdev)
{
...
# 1562 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
...
# 1747 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
USB_OTG_STS USB_OTG_EP0StartXfer(USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep)
{
  USB_OTG_STS status = USB_OTG_OK;
  USB_OTG_DEPCTL_TypeDef depctl;
...
# 1932 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_ReadDevOutEP_itr(USB_OTG_CORE_HANDLE *pdev , uint8_t epnum)
{
  uint32_t v;
...
# 2080 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
uint32_t USB_OTG_GetEPStatus(USB_OTG_CORE_HANDLE *pdev ,USB_OTG_EP *ep)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
...
# 2134 "stm/lib/STM32_USB_OTG_Driver/src/usb_core.c"
void USB_OTG_SetEPStatus (USB_OTG_CORE_HANDLE *pdev , USB_OTG_EP *ep , uint32_t Status)
{
  USB_OTG_DEPCTL_TypeDef depctl;
  volatile uint32_t *depctl_addr;
