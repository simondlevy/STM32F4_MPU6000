...
# 26 "stm/src/usb_io.c" 2

static IO_t usbDetectPin;

void usbCableDetectInit(void)
{
    usbDetectPin = IOGetByTag(0);

    IOInit(usbDetectPin, OWNER_USB_DETECT, 0);
    IOConfigGPIO(usbDetectPin, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_DOWN) << 5)));
}
