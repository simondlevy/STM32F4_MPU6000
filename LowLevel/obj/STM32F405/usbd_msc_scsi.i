# 0 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
# 29 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
# 1 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_bot.h" 1
# 30 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_bot.h"
...
# 35 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_core.h" 2
...
# 31 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_bot.h" 2
# 83 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_bot.h"
...
MSC_BOT_CSW_TypeDef;
# 114 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_bot.h"
...
void MSC_BOT_CplClrFeature (USB_OTG_CORE_HANDLE *pdev,
                             uint8_t epnum);
# 30 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 1 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h" 1
# 33 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_def.h" 1
# 34 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h" 2
# 116 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h"
...
# 133 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h"
...
# 159 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_scsi.h"
...
void SCSI_SenseCode(uint8_t lun,
                    uint8_t sKey,
                    uint8_t ASC);
# 31 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 1 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_mem.h" 1
# 58 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_mem.h"
...
# 95 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_mem.h"
extern USBD_STORAGE_cb_TypeDef *USBD_STORAGE_fops;
# 32 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 1 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_data.h" 1
# 78 "stm/lib/STM32_USB_Device_Library/Class/msc/inc/usbd_msc_data.h"
extern const uint8_t MSC_Page00_Inquiry_Data[];
extern const uint8_t MSC_Mode_Sense6_data[];
extern const uint8_t MSC_Mode_Sense10_data[] ;
# 33 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c" 2
# 79 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 98 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 133 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
int8_t SCSI_ProcessCmd(USB_OTG_CORE_HANDLE *pdev,
                           uint8_t lun,
                           uint8_t *params)
{
...
# 192 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_TestUnitReady(uint8_t lun, uint8_t *params)
{
  (void)(params);
...
# 222 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Inquiry(uint8_t lun, uint8_t *params)
{
  uint8_t* pPage;
  uint16_t len;
...
# 260 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ReadCapacity10(uint8_t lun, uint8_t *params)
{
  (void)(params);
...
# 363 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ModeSense10 (uint8_t lun, uint8_t *params)
{
 (void)(params);
 uint16_t len = 8;
...
# 391 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_RequestSense (uint8_t lun, uint8_t *params)
{
  (void)(lun);
  uint8_t i;
...
# 434 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 467 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Read10(uint8_t lun , uint8_t *params)
{
  if(MSC_BOT_State == 0)
  {
...
# 531 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Write10 (uint8_t lun , uint8_t *params)
{
  if (MSC_BOT_State == 0)
  {
...
# 613 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_Verify10(uint8_t lun , uint8_t *params){
...
# 643 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
...
# 703 "stm/lib/STM32_USB_Device_Library/Class/msc/src/usbd_msc_scsi.c"
static int8_t SCSI_ProcessWrite (uint8_t lun)
{
  uint32_t len;
