# 0 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
# 29 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
# 1 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_req.h" 1
# 34 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_req.h"
...
# 35 "stm/lib/STM32_USB_Device_Library/Core/inc/usbd_req.h" 2
...
# 30 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
...
uint16_t USBD_GetRxCount (USB_OTG_CORE_HANDLE *pdev ,
                           uint8_t epnum);
# 31 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
...
# 32 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c" 2
# 72 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
...
# 104 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
...
# 143 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdDevReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
...
# 194 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdItfReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
  USBD_Status ret = USBD_OK;
...
# 231 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
USBD_Status USBD_StdEPReq (USB_OTG_CORE_HANDLE *pdev, USB_SETUP_REQ *req)
{
                               ...
                               USB_SETUP_REQ *req)
{
  ...
  case 3:
    ...
    break;
  case 6:
# 462 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
      USBD_CtlError(pdev , req);
      return;


  case 7:
# 481 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
      USBD_CtlError(pdev , req);
      return;
...
# 508 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetAddress(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  uint8_t dev_addr;
...
# 550 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetConfig(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 619 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_GetConfig(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 659 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_GetStatus(USB_OTG_CORE_HANDLE *pdev,
                           USB_SETUP_REQ *req)
{
...
# 699 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_SetFeature(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
...
# 763 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
static void USBD_ClrFeature(USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  switch (pdev->dev.device_status)
...
# 792 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_ParseSetupRequest( USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
...
# 813 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_CtlError( USB_OTG_CORE_HANDLE *pdev,
                            USB_SETUP_REQ *req)
{
  (void)req;
...
# 831 "stm/lib/STM32_USB_Device_Library/Core/src/usbd_req.c"
void USBD_GetString(uint8_t *desc, uint8_t *unicode, uint16_t *len)
{
  uint8_t idx = 0;
