# 0 "stm/src/vcpf4/usbd_desc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "stm/src/vcpf4/usbd_desc.c"
# 23 "stm/src/vcpf4/usbd_desc.c"
...
# 24 "stm/src/vcpf4/usbd_desc.c" 2
...
# 25 "stm/src/vcpf4/usbd_desc.c" 2
...
# 26 "stm/src/vcpf4/usbd_desc.c" 2
# 1 "stm/src/vcpf4/usbd_conf.h" 1
# 27 "stm/src/vcpf4/usbd_desc.c" 2
# 1 "stm/lib/STM32_USB_OTG_Driver/inc/usb_regs.h" 1
# 28 "stm/src/vcpf4/usbd_desc.c" 2
# 105 "stm/src/vcpf4/usbd_desc.c"
...
# 248 "stm/src/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{


  if (speed == 0)
    USBD_GetString ((uint8_t*)"Hackflight STM32F405", USBD_StrDesc, length);
  else
    USBD_GetString ((uint8_t*)"Hackflight STM32F405", USBD_StrDesc, length);

  return USBD_StrDesc;
}
# 267 "stm/src/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_ManufacturerStrDescriptor( uint8_t speed , uint16_t *length)
{
    (void)speed;
  USBD_GetString ((uint8_t*)"Hackflight", USBD_StrDesc, length);
  return USBD_StrDesc;
}
# 281 "stm/src/vcpf4/usbd_desc.c"
uint8_t * USBD_USR_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  if (speed == 0)
