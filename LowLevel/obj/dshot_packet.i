# 0 "hfsrc/escs/dshot/dshot_packet.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "hfsrc/escs/dshot/dshot_packet.c"
# 19 "hfsrc/escs/dshot/dshot_packet.c"
...
# 20 "hfsrc/escs/dshot/dshot_packet.c" 2
...
# 21 "hfsrc/escs/dshot/dshot_packet.c" 2
...
# 20 "hfsrc/escs/dshot/dshot_dev.h" 2
...
# 22 "hfsrc/escs/dshot/dshot_dev.h" 2
...
# 28 "hfsrc/escs/dshot/dshot_dev.h" 3 4
   _Bool 
# 28 "hfsrc/escs/dshot/dshot_dev.h"
        requestTelemetry;
...
# 46 "hfsrc/escs/dshot/dshot_dev.h" 3 4
   _Bool 
# 46 "hfsrc/escs/dshot/dshot_dev.h"
        configured;
    uint8_t output;
    uint8_t index;
    uint32_t iocfg;
    ...
    volatile 
# 51 "hfsrc/escs/dshot/dshot_dev.h" 3 4
            _Bool 
# 51 "hfsrc/escs/dshot/dshot_dev.h"
                 isInput;
...
# 22 "hfsrc/escs/dshot/dshot_packet.c" 2
# 1 "stm/src/nvic.h" 1
# 17 "stm/src/nvic.h"
       
# 23 "hfsrc/escs/dshot/dshot_packet.c" 2

uint16_t getDshotPacketAtomic(dshotProtocolControl_t *pcb)
{
    uint16_t packet = 0;

    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((2)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        packet = (pcb->value << 1) | (pcb->requestTelemetry ? 1 : 0);


        pcb->requestTelemetry = 
# 32 "hfsrc/escs/dshot/dshot_packet.c" 3 4
                               0
# 32 "hfsrc/escs/dshot/dshot_packet.c"
                                    ;
    }
